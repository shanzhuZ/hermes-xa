...
> **定位**：本项目交互亮点 —— 对齐「密塔 AI」：**关键选择在开始前完成，后续自动执行**。  
> **2026-07-06 更新**：[01 账号信息采集](workflows/01-账号信息采集.md) 采用 **仅首步一次点选**（`collect.cross_platform`），阶段 2～8 **禁止** clarify。本文其余多步 clarify 模式适用于第 2～4 类业务或历史存档流程。

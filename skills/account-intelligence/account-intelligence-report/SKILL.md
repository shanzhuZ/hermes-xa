...
- **步骤11** 必须按照整体章节的结构输出（一～六章齐全），每一章节内容必须使用整段叙述性文字描述。不要换行输出展示
...
## 五、个人画像情况
一是年龄/体貌等。依据发文称xxxx。二是婚恋/职业/学历等。依据发文称xxxx。三是籍贯/活动地等。依据发文称xxxx。四是网络习惯等。依据xxxx。
（可与「四、核查思路」内容重叠，须整段叙述；禁止空章）

## 六、综合研判与核查情况
结合以上信息，初步研判……。建议后续：第一步……；第二步……；第三步……。
（可与前文重叠；须含综合结论与后续核查建议；禁止空章）
```
